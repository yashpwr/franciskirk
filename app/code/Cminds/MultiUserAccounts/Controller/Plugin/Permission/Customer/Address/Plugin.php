...
namespace Cminds\MultiUserAccounts\Controller\Plugin\Permission\Customer\Address;
...
/**
 * Cminds MultiUserAccounts customer account address controller plugin.
 *
 * @category Cminds
    ...
    public function beforeDispatch(
        ...
        if ($accountDataModificationPermission === false) {
            ...
            $this->messageManager->addErrorMessage(
                __('You don\'t have permission to edit account address information.')
            );
