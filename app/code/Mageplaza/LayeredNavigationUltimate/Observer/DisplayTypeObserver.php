...
class DisplayTypeObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $dependencies->addFieldMap(LayerHelper::FIELD_DISPLAY_TYPE, LayerHelper::FIELD_DISPLAY_TYPE)
            ...
            ->addFieldDependence(LayerHelper::FIELD_DISPLAY_TYPE, LayerHelper::FIELD_FILTER_TYPE, LayerHelper::FILTER_TYPE_LIST)
            ->addFieldDependence(LayerHelper::FIELD_DISPLAY_SIZE, LayerHelper::FIELD_FILTER_TYPE, LayerHelper::FILTER_TYPE_LIST)
            ->addFieldDependence(LayerHelper::FIELD_DISPLAY_HEIGHT, LayerHelper::FIELD_FILTER_TYPE, LayerHelper::FILTER_TYPE_LIST)
            ->addFieldDependence(LayerHelper::FIELD_DISPLAY_SIZE, LayerHelper::FIELD_DISPLAY_TYPE, DisplayType::TYPE_HIDDEN)
            ->addFieldDependence(LayerHelper::FIELD_DISPLAY_HEIGHT, LayerHelper::FIELD_DISPLAY_TYPE, DisplayType::TYPE_SCROLL);
