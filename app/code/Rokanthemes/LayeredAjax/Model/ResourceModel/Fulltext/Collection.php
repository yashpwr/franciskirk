...
namespace Rokanthemes\LayeredAjax\Model\ResourceModel\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
	...
	public function getSearchCriteriaBuilder()
	{
		if ($this->searchCriteriaBuilder === null) {
			$this->searchCriteriaBuilder = ObjectManager::getInstance()
				->get('\Rokanthemes\LayeredAjax\Model\Search\SearchCriteriaBuilder');
		}
	...
	public function setSearchCriteriaBuilder(\Rokanthemes\LayeredAjax\Model\Search\SearchCriteriaBuilder $object)
	{
