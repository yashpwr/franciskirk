...
return [
    'modules' => [
        ...
        'MageWorx_CustomerPricesImportExport' => 1,
        'MageWorx_Info' => 1,
        ...
        'Mageplaza_Smtp' => 1,
        'Mahesh_CustomCategoryDisplayMode' => 1,
        'Mahesh_CustomerCustomAttribute' => 1,
        'Mahesh_ProductBreadcrumbs' => 1,
